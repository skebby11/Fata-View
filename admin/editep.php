...
if(isset($_POST['aggiornaep'])){
	...
	$query = "UPDATE episodi SET stagione = " . $upstagione . ", episodio = ".$_POST['upepisodio'].", serie = ".$_POST['upserie']." , titolo = '$uptitolo', link = '".$_POST['uplink']."', linksv = '".$_POST['uplinksv']."' WHERE id = $selepid";
	mysqli_query($db, $query);
